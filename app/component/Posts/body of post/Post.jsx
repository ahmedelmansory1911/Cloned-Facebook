...
function Post({ message, postImage, time }) {
    const date = time ? new Date(time.seconds * 1000) : null;
       ...
       <div className="card relative rounded-xl bg-white">
                        ...
                        <div className='flex justify-start items-center'>
                            ...
                            <div className='flex flex-col left-2 top-[1px] relative'>
                                <span className="items-center no-underline top-1 relative font-semibold	text-base">Ahmed Elmansory</span>
                                {/*  */}
                                <div className='flex flex-row'>
                            <span className='text-xs font-normal	'>{date && <p>{date.toLocaleString()}</p>}</span>
